...
countBtn.addEventListener('click', function(){
    ...
    if (appData.budget != undefined) {
        ...
        if (appData.moneyPerDay < 100) {
            levelVal.textContent = "Это минимальный уровень достатка!";
        } else if (appData.moneyPerDay > 100 && appData.moneyPerDay < 2000) {
            levelVal.textContent = "Это средний уровень достатка!";
        } else if (appData.moneyPerDay > 2000) {
            levelVal.textContent = "Это высокий уровень достатка!";
        } else {
            levelVal.textContent = "Ошибочка...!";
        }
    } else {
